        ...
        <div className="mb-8 grid grid-cols-1 gap-4">
          <div className="flex items-center gap-4 rounded-2xl bg-blue-50 p-4">
            ...
            <div>
              ...
              <div className="text-sm font-black text-slate-900">support@roomzy.in</div>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              rows={4}
              className="w-full resize-none rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm font-bold outline-none focus:border-blue-500"
            />
          </div>
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-xl bg-blue-600 py-4 text-sm font-black text-white shadow-xl shadow-blue-100 transition-all active:scale-95 disabled:opacity-60 disabled:cursor-not-allowed"
          >
            {isSubmitting ? (
